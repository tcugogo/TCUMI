...
namespace Basic_Streaming.NET.Views
{
    ...
    public partial class ScannedSensors : UserControl
    {
        ...
        public void clk_ArmPipeline(object sender, RoutedEventArgs e)
        {
            ...
            _uc.btn_PairSensors.IsEnabled = true;
            _uc.btn_ScanSensors.IsEnabled = true;
            _uc.btn_Start.IsEnabled = false;
            (this.Parent as Grid).Children.Remove(this);

            _uc.Start_Grid.Visibility = Visibility.Visible;
            _uc.Streaming_grid.Visibility = Visibility.Collapsed;
        }
